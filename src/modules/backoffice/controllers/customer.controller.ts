...
export class CustomerController {
  ...
  async post(@Body() model: CreateCustomerDto) {
    try {
      ...
      return new Result(
        ...
        true,
        { user: user, customer: createdCustomer },
        null
      )
    } catch (error) {
      //rollback manual
      throw new HttpException(
        new Result('Erro ao cadastrar o cliente', false, null, error),
  ...
  async put(
    ...
    try {
      ...
      //rollback manual
      throw new HttpException(
        new Result('Erro ao alterar o cliente', false, null, error),
        HttpStatus.BAD_REQUEST
      )
    }
  }
  ...
  async query(@Body() model: QueryDto) {
    try {
      ...
      //rollback manual
      throw new HttpException(
        new Result('Erro ao executar a query', false, null, error),
        HttpStatus.BAD_REQUEST
      )
    }
  }
  ...
  async createCreditCard(
    ...
    try {
      ...
      //rollback manual
      throw new HttpException(
        new Result('Erro ao cadastrar o cartão de crédito', false, null, error),
        HttpStatus.BAD_REQUEST
      )
    }
  }
